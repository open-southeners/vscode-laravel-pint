...
/** Debug messages */
export const UPDATING_EXTENSION_EXCLUDE_PATTERNS = 'Found changes to a pint.json config file, updating the extension excludes...';
export const CONFIG_PATHS_FOUND_FOR_WORKSPACE = 'Config files found on workspace';
export const NO_CONFIG_FOUND_FOR_WORKSPACE = 'No config matches for workspace';
export const ENABLING_PINT_FOR_WORKSPACE = 'Enabling Laravel Pint for workspace';
export const RUNNING_PINT_ON_PATH = 'Formatting file(s) using Pint';